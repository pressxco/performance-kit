...
class RuleInclusionTest extends TestCase {
	...
	public static function setUpBeforeClass() {
		...
		$config        = new Config( array( "--standard=$standard" ) );
	...
	public function dataSettingProperties() {
		return array(
			'ClassDeclarationSniff'                           => array(
				'PHP_CodeSniffer\Standards\PSR1\Sniffs\Classes\ClassDeclarationSniff',
				'setforallsniffs',
				true,
			),
			'SideEffectsSniff'                                => array(
				'PHP_CodeSniffer\Standards\PSR1\Sniffs\Files\SideEffectsSniff',
				'setforallsniffs',
				true,
			),
			'ValidVariableNameSniff'                          => array(
				'PHP_CodeSniffer\Standards\Zend\Sniffs\NamingConventions\ValidVariableNameSniff',
				'setforallincategory',
				true,
			),
			'ArrayIndentSniff'                                => array(
				'PHP_CodeSniffer\Standards\Generic\Sniffs\Arrays\ArrayIndentSniff',
				'indent',
				'2',
			),
			'LineLengthSniff'                                 => array(
				'PHP_CodeSniffer\Standards\Generic\Sniffs\Files\LineLengthSniff',
				'lineLimit',
				'10',
			),
			'CamelCapsFunctionNameSniff'                      => array(
				'PHP_CodeSniffer\Standards\Generic\Sniffs\NamingConventions\CamelCapsFunctionNameSniff',
				'strict',
				false,
			),
			'NestingLevelSniff-nestingLevel'                  => array(
				'PHP_CodeSniffer\Standards\Generic\Sniffs\Metrics\NestingLevelSniff',
				'nestingLevel',
				'2',
			),
			'NestingLevelSniff-setforsniffsinincludedruleset' => array(
				'PHP_CodeSniffer\Standards\Generic\Sniffs\Metrics\NestingLevelSniff',
			...
			'CyclomaticComplexitySniff'                       => array(
				'PHP_CodeSniffer\Standards\Generic\Sniffs\Metrics\CyclomaticComplexitySniff',
				'complexity',
				10,
			),
