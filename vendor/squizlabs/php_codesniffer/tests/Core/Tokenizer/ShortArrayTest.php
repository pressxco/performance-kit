...
class ShortArrayTest extends AbstractMethodUnitTest {
	...
	public function dataSquareBrackets() {
		return array(
			array( '/* testArrayAccess1 */' ),
			array( '/* testArrayAccess2 */' ),
			array( '/* testArrayAssignment */' ),
			array( '/* testFunctionCallDereferencing */' ),
			array( '/* testMethodCallDereferencing */' ),
			array( '/* testStaticMethodCallDereferencing */' ),
			array( '/* testPropertyDereferencing */' ),
			array( '/* testPropertyDereferencingWithInaccessibleName */' ),
			array( '/* testStaticPropertyDereferencing */' ),
			array( '/* testStringDereferencing */' ),
			array( '/* testStringDereferencingDoubleQuoted */' ),
			array( '/* testConstantDereferencing */' ),
			array( '/* testClassConstantDereferencing */' ),
			array( '/* testMagicConstantDereferencing */' ),
			array( '/* testArrayAccessCurlyBraces */' ),
			array( '/* testArrayLiteralDereferencing */' ),
			array( '/* testShortArrayLiteralDereferencing */' ),
			array( '/* testClassMemberDereferencingOnInstantiation1 */' ),
			array( '/* testClassMemberDereferencingOnInstantiation2 */' ),
			array( '/* testClassMemberDereferencingOnClone */' ),
			array( '/* testNullsafeMethodCallDereferencing */' ),
			array( '/* testLiveCoding */' ),
		);
	...
	public function dataShortArrays() {
		return array(
			array( '/* testShortArrayDeclarationEmpty */' ),
			array( '/* testShortArrayDeclarationWithOneValue */' ),
			array( '/* testShortArrayDeclarationWithMultipleValues */' ),
			array( '/* testShortArrayDeclarationWithDereferencing */' ),
			array( '/* testShortListDeclaration */' ),
			array( '/* testNestedListDeclaration */' ),
			array( '/* testArrayWithinFunctionCall */' ),
		);
