...
class BackfillFnTokenTest extends AbstractMethodUnitTest {
	...
	public function testSimple() {
		...
		foreach ( array( '/* testStandard */', '/* testMixedCase */' ) as $comment ) {
	...
	public function dataNotAnArrowFunction() {
		return array(
			...
			array( '/* testStaticMethodName */' ),
			array( '/* testPropertyAssignment */' ),
			array(
				'/* testAnonClassMethodName */',
				'fN',
			),
			array( '/* testNonArrowStaticMethodCall */' ),
			array(
			...
			array( '/* testNonArrowObjectMethodCall */' ),
			array(
			...
			array( '/* testNonArrowNamespaceOperatorFunctionCall */' ),
